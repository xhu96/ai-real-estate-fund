...
"""Offline adapter stub for appraisal reports.
...
class AppraisalAdapter:
    provider_name = 'appraisal reports'
    expected_fields = ['value', 'approach', 'cap_rate', 'comps']
    ...
    def plan_query(self, query: AppraisalAdapterQuery) -> dict[str, Any]:
        return {
    ...
    def fetch(self, query: AppraisalAdapterQuery) -> list[AppraisalAdapterRecord]:
        planned = self.plan_query(query)
        return [
            AppraisalAdapterRecord(
    ...
    def normalize(self, records: list[AppraisalAdapterRecord]) -> list[dict[str, Any]]:
    ...
    def quality_warnings(self, record: AppraisalAdapterRecord) -> list[str]:
        warnings: list[str] = []
