...
"""Offline adapter stub for inspection reports.
...
class InspectionAdapter:
    provider_name = 'inspection reports'
    expected_fields = ['system', 'condition', 'severity', 'cost']
    ...
    def plan_query(self, query: InspectionAdapterQuery) -> dict[str, Any]:
        return {
    ...
    def fetch(self, query: InspectionAdapterQuery) -> list[InspectionAdapterRecord]:
        planned = self.plan_query(query)
        return [
            InspectionAdapterRecord(
    ...
    def normalize(self, records: list[InspectionAdapterRecord]) -> list[dict[str, Any]]:
    ...
    def quality_warnings(self, record: InspectionAdapterRecord) -> list[str]:
        warnings: list[str] = []
