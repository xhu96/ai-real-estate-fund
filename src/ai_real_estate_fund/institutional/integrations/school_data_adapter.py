...
"""Offline adapter stub for school data.
...
class SchoolDataAdapter:
    provider_name = 'school data'
    expected_fields = ['school_name', 'rating', 'assignment', 'distance']
    ...
    def plan_query(self, query: SchoolDataAdapterQuery) -> dict[str, Any]:
        return {
    ...
    def fetch(self, query: SchoolDataAdapterQuery) -> list[SchoolDataAdapterRecord]:
        planned = self.plan_query(query)
        return [
            SchoolDataAdapterRecord(
    ...
    def normalize(self, records: list[SchoolDataAdapterRecord]) -> list[dict[str, Any]]:
    ...
    def quality_warnings(self, record: SchoolDataAdapterRecord) -> list[str]:
        warnings: list[str] = []
