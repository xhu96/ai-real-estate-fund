...
"""Asset-management monitor for NOI variance.
...
class NoiVarianceMonitorConfig:
    target: float = 1.0
...
class NoiVarianceMonitor:
    name = 'NOI variance'
    description = 'actual NOI versus budget'
    owner = 'asset_manager'

    def __init__(self, config: NoiVarianceMonitorConfig | None = None) -> None:
        self.config = config or NoiVarianceMonitorConfig()
