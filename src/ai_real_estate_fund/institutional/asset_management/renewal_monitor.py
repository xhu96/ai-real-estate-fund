...
"""Asset-management monitor for renewals.
...
class RenewalMonitor:
    name = 'renewals'
    description = 'expiring leases converted to renewals'
    owner = 'leasing_manager'

    def __init__(self, config: RenewalMonitorConfig | None = None) -> None:
        self.config = config or RenewalMonitorConfig()
