...
"""Asset-management monitor for collections.
...
class CollectionsMonitorConfig:
    target: float = 1.0
...
class CollectionsMonitor:
    name = 'collections'
    description = 'cash collected against tenant ledger'
    owner = 'property_manager'

    def __init__(self, config: CollectionsMonitorConfig | None = None) -> None:
        self.config = config or CollectionsMonitorConfig()
