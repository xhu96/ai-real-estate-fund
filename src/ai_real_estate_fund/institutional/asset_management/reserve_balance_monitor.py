...
"""Asset-management monitor for reserve balance.
...
class ReserveBalanceMonitorConfig:
    target: float = 1.0
...
class ReserveBalanceMonitor:
    name = 'reserve balance'
    description = 'available reserves versus policy minimum'
    owner = 'controller'

    def __init__(self, config: ReserveBalanceMonitorConfig | None = None) -> None:
        self.config = config or ReserveBalanceMonitorConfig()
