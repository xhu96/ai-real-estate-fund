...
"""Asset-management monitor for safety incidents.
...
class SafetyIncidentMonitorConfig:
    target: float = 1.0
...
class SafetyIncidentMonitor:
    name = 'safety incidents'
    description = 'incidents per occupied unit'
    owner = 'risk_manager'

    def __init__(self, config: SafetyIncidentMonitorConfig | None = None) -> None:
        self.config = config or SafetyIncidentMonitorConfig()
