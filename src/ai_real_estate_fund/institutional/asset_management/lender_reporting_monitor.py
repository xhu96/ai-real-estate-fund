...
"""Asset-management monitor for lender reporting.
...
class LenderReportingMonitorConfig:
    target: float = 1.0
...
class LenderReportingMonitor:
    name = 'lender reporting'
    description = 'reporting package timeliness'
    owner = 'controller'

    def __init__(self, config: LenderReportingMonitorConfig | None = None) -> None:
        self.config = config or LenderReportingMonitorConfig()
