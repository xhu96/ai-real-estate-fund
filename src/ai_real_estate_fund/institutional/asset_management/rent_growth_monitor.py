...
"""Asset-management monitor for rent growth.
...
class RentGrowthMonitor:
    name = 'rent growth'
    description = 'achieved rents versus underwritten rents'
    owner = 'asset_manager'

    def __init__(self, config: RentGrowthMonitorConfig | None = None) -> None:
        self.config = config or RentGrowthMonitorConfig()
