...
"""Asset-management monitor for manager scorecard.
...
class ManagerScorecardMonitorConfig:
    target: float = 1.0
...
class ManagerScorecardMonitor:
    name = 'manager scorecard'
    description = 'operator KPI scorecard'
    owner = 'portfolio_manager'

    def __init__(self, config: ManagerScorecardMonitorConfig | None = None) -> None:
        self.config = config or ManagerScorecardMonitorConfig()
