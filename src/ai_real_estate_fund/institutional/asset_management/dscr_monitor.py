...
"""Asset-management monitor for DSCR.
...
class DscrMonitor:
    name = 'DSCR'
    description = 'NOI divided by debt service'
    owner = 'debt_asset_manager'

    def __init__(self, config: DscrMonitorConfig | None = None) -> None:
        self.config = config or DscrMonitorConfig()
