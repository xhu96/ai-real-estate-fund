...
"""Asset-management monitor for turn time.
...
class TurnTimeMonitor:
    name = 'turn time'
    description = 'days from move-out to rent-ready'
    owner = 'maintenance_lead'

    def __init__(self, config: TurnTimeMonitorConfig | None = None) -> None:
        self.config = config or TurnTimeMonitorConfig()
