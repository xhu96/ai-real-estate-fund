...
"""Asset-management monitor for business-plan milestones.
...
class BusinessPlanMilestoneMonitorConfig:
    target: float = 1.0
...
class BusinessPlanMilestoneMonitor:
    name = 'business-plan milestones'
    description = 'completed milestones versus approved plan'
    owner = 'asset_manager'

    def __init__(self, config: BusinessPlanMilestoneMonitorConfig | None = None) -> None:
        self.config = config or BusinessPlanMilestoneMonitorConfig()
