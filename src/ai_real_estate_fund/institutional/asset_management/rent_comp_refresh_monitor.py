...
"""Asset-management monitor for rent comp refresh.
...
class RentCompRefreshMonitorConfig:
    target: float = 1.0
...
class RentCompRefreshMonitor:
    name = 'rent comp refresh'
    description = 'freshness of rent comp evidence'
    owner = 'research_lead'

    def __init__(self, config: RentCompRefreshMonitorConfig | None = None) -> None:
        self.config = config or RentCompRefreshMonitorConfig()
