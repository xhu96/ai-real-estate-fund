...
"""Asset-management monitor for economic occupancy.
...
class EconomicOccupancyMonitorConfig:
    target: float = 1.0
...
class EconomicOccupancyMonitor:
    name = 'economic occupancy'
    description = 'collected rent divided by scheduled rent'
    owner = 'asset_manager'

    def __init__(self, config: EconomicOccupancyMonitorConfig | None = None) -> None:
        self.config = config or EconomicOccupancyMonitorConfig()
