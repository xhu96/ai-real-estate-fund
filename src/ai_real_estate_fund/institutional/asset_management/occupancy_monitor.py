...
"""Asset-management monitor for occupancy.
...
class OccupancyMonitor:
    name = 'occupancy'
    description = 'occupied units divided by rentable units'
    owner = 'leasing_manager'

    def __init__(self, config: OccupancyMonitorConfig | None = None) -> None:
        self.config = config or OccupancyMonitorConfig()
