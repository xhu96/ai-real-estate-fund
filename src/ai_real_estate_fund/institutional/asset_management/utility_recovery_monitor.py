...
"""Asset-management monitor for utility recovery.
...
class UtilityRecoveryMonitorConfig:
    target: float = 1.0
...
class UtilityRecoveryMonitor:
    name = 'utility recovery'
    description = 'tenant reimbursements against utility expense'
    owner = 'asset_manager'

    def __init__(self, config: UtilityRecoveryMonitorConfig | None = None) -> None:
        self.config = config or UtilityRecoveryMonitorConfig()
