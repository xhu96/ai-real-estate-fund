...
"""Asset-management monitor for covenant compliance.
...
class CovenantComplianceMonitorConfig:
    target: float = 1.0
    tolerance: float = 0.10
    unit: str = "ratio"
    owner: str = 'debt_asset_manager'
    enabled: bool = True


class CovenantComplianceMonitor:
    name = 'covenant compliance'
    description = 'lender covenant headroom'
    owner = 'debt_asset_manager'

    def __init__(self, config: CovenantComplianceMonitorConfig | None = None) -> None:
        self.config = config or CovenantComplianceMonitorConfig()
