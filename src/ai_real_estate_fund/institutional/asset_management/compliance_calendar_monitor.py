...
"""Asset-management monitor for compliance calendar.
...
class ComplianceCalendarMonitorConfig:
    target: float = 1.0
...
class ComplianceCalendarMonitor:
    name = 'compliance calendar'
    description = 'licenses, inspections, and filings'
    owner = 'compliance_lead'

    def __init__(self, config: ComplianceCalendarMonitorConfig | None = None) -> None:
        self.config = config or ComplianceCalendarMonitorConfig()
