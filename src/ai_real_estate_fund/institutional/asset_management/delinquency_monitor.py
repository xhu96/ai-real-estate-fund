...
"""Asset-management monitor for delinquency.
...
class DelinquencyMonitorConfig:
    target: float = 1.0
...
class DelinquencyMonitor:
    name = 'delinquency'
    description = 'past-due balance as a share of monthly rent'
    owner = 'property_manager'

    def __init__(self, config: DelinquencyMonitorConfig | None = None) -> None:
        self.config = config or DelinquencyMonitorConfig()
