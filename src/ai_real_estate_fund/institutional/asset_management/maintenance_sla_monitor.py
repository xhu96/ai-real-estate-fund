...
"""Asset-management monitor for maintenance SLA.
...
class MaintenanceSlaMonitorConfig:
    target: float = 1.0
    tolerance: float = 0.10
    unit: str = "ratio"
    owner: str = 'maintenance_lead'
    enabled: bool = True
...
class MaintenanceSlaMonitor:
    ...
    def __init__(self, config: MaintenanceSlaMonitorConfig | None = None) -> None:
        self.config = config or MaintenanceSlaMonitorConfig()
