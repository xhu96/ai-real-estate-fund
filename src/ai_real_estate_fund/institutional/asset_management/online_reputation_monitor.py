...
"""Asset-management monitor for online reputation.
...
class OnlineReputationMonitorConfig:
    target: float = 1.0
...
class OnlineReputationMonitor:
    name = 'online reputation'
    description = 'reviews and response cadence'
    owner = 'property_manager'

    def __init__(self, config: OnlineReputationMonitorConfig | None = None) -> None:
        self.config = config or OnlineReputationMonitorConfig()
