...
"""Asset-management monitor for capex budget.
...
class CapexBudgetMonitorConfig:
    target: float = 1.0
...
class CapexBudgetMonitor:
    name = 'capex budget'
    description = 'capex spend versus approved budget'
    owner = 'construction_manager'

    def __init__(self, config: CapexBudgetMonitorConfig | None = None) -> None:
        self.config = config or CapexBudgetMonitorConfig()
