...
"""Detailed underwriting model for construction draws.
...
class ConstructionDrawModelResult:
    subject: str
    lens: str
    base_value: float
...
class ConstructionDrawModel:
    subject = 'construction draws'
    lens = 'rehab cash timing'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> ConstructionDrawModelResult:
        return ConstructionDrawModelResult(
