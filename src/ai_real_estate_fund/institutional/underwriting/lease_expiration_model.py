...
"""Detailed underwriting model for lease expirations.
...
class LeaseExpirationModelResult:
    subject: str
    lens: str
    base_value: float
...
class LeaseExpirationModel:
    subject = 'lease expirations'
    lens = 'rollover risk'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> LeaseExpirationModelResult:
        return LeaseExpirationModelResult(
