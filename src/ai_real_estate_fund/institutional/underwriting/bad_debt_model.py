...
"""Detailed underwriting model for bad debt.
...
class BadDebtModel:
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> BadDebtModelResult:
        return BadDebtModelResult(
