...
"""Detailed underwriting model for insurance escalation.
...
class InsuranceEscalationModelResult:
    subject: str
    lens: str
    base_value: float
...
class InsuranceEscalationModel:
    subject = 'insurance escalation'
    lens = 'premium shock'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> InsuranceEscalationModelResult:
        return InsuranceEscalationModelResult(
