...
"""Detailed underwriting model for tax appeal.
...
class PropertyTaxAppealModelResult:
    subject: str
    lens: str
    base_value: float
...
class PropertyTaxAppealModel:
    subject = 'tax appeal'
    lens = 'assessment mitigation'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> PropertyTaxAppealModelResult:
        return PropertyTaxAppealModelResult(
