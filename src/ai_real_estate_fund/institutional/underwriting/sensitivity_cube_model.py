...
"""Detailed underwriting model for sensitivity cube.
...
class SensitivityCubeModelResult:
    subject: str
    lens: str
    base_value: float
...
class SensitivityCubeModel:
    subject = 'sensitivity cube'
    lens = 'multi-variable stress'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> SensitivityCubeModelResult:
        return SensitivityCubeModelResult(
