...
"""Detailed underwriting model for repair reserves.
...
class RepairReserveModelResult:
    subject: str
    lens: str
    base_value: float
...
class RepairReserveModel:
    subject = 'repair reserves'
    lens = 'maintenance normalization'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> RepairReserveModelResult:
        return RepairReserveModelResult(
