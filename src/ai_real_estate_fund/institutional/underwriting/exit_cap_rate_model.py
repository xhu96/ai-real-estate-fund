...
"""Detailed underwriting model for exit cap rate.
...
class ExitCapRateModel:
    subject = 'exit cap rate'
    lens = 'terminal value'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> ExitCapRateModelResult:
        return ExitCapRateModelResult(
