...
"""Detailed underwriting model for tenant improvements.
...
class TenantImprovementModelResult:
    subject: str
    lens: str
    base_value: float
...
class TenantImprovementModel:
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> TenantImprovementModelResult:
        return TenantImprovementModelResult(
