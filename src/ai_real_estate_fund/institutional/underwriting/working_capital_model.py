...
"""Detailed underwriting model for working capital.
...
class WorkingCapitalModelResult:
    subject: str
    lens: str
    base_value: float
...
class WorkingCapitalModel:
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> WorkingCapitalModelResult:
        return WorkingCapitalModelResult(
