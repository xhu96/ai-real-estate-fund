...
"""Detailed underwriting model for tax reassessment.
...
class TaxReassessmentModelResult:
    subject: str
    lens: str
    base_value: float
...
class TaxReassessmentModel:
    subject = 'tax reassessment'
    lens = 'post-sale tax reset'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> TaxReassessmentModelResult:
        return TaxReassessmentModelResult(
