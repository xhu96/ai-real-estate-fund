...
"""Detailed underwriting model for utility reimbursements.
...
class UtilityReimbursementModelResult:
    subject: str
    lens: str
    base_value: float
...
class UtilityReimbursementModel:
    subject = 'utility reimbursements'
    lens = 'expense leakage'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> UtilityReimbursementModelResult:
        return UtilityReimbursementModelResult(
