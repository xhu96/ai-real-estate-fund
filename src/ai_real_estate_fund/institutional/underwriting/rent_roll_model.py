...
"""Detailed underwriting model for rent roll.
...
class RentRollModel:
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> RentRollModelResult:
        return RentRollModelResult(
