...
"""Detailed underwriting model for sale costs.
...
class SaleCostModel:
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> SaleCostModelResult:
        return SaleCostModelResult(
