...
"""Detailed underwriting model for concessions.
...
class ConcessionModel:
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> ConcessionModelResult:
        return ConcessionModelResult(
