...
"""Detailed underwriting model for reserve sizing.
...
class ReserveSizingModelResult:
    subject: str
    lens: str
    base_value: float
...
class ReserveSizingModel:
    subject = 'reserve sizing'
    lens = 'liquidity buffer'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> ReserveSizingModelResult:
        return ReserveSizingModelResult(
