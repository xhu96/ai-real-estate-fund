...
"""Detailed underwriting model for valuation reconciliation.
...
class ValuationReconciliationModelResult:
    subject: str
    lens: str
    base_value: float
...
class ValuationReconciliationModel:
    subject = 'valuation reconciliation'
    lens = 'income/comps/cost'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> ValuationReconciliationModelResult:
        return ValuationReconciliationModelResult(
