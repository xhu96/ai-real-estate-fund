...
"""Detailed underwriting model for equity waterfall.
...
class WaterfallModel:
    subject = 'equity waterfall'
    lens = 'distribution priority'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> WaterfallModelResult:
        return WaterfallModelResult(
