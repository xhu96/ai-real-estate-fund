...
"""Detailed underwriting model for operating KPIs.
...
class OperatingKpiModel:
    subject = 'operating KPIs'
    lens = 'asset-management monitoring'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> OperatingKpiModelResult:
        return OperatingKpiModelResult(
