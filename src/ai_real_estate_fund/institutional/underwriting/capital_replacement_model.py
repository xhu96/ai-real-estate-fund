...
"""Detailed underwriting model for capital replacements.
...
class CapitalReplacementModelResult:
    subject: str
    lens: str
    base_value: float
...
class CapitalReplacementModel:
    subject = 'capital replacements'
    lens = 'component useful life'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> CapitalReplacementModelResult:
        return CapitalReplacementModelResult(
