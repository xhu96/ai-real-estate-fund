...
"""Detailed underwriting model for refinance proceeds.
...
class RefinanceProceedsModelResult:
    subject: str
    lens: str
    base_value: float
...
class RefinanceProceedsModel:
    subject = 'refinance proceeds'
    lens = 'takeout financing'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> RefinanceProceedsModelResult:
        return RefinanceProceedsModelResult(
