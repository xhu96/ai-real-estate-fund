...
"""Detailed underwriting model for debt service.
...
class DebtServiceModel:
    subject = 'debt service'
    lens = 'amortization burden'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> DebtServiceModelResult:
        return DebtServiceModelResult(
