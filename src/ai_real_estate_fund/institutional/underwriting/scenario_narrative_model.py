...
"""Detailed underwriting model for scenario narrative.
...
class ScenarioNarrativeModelResult:
    subject: str
    lens: str
    base_value: float
...
class ScenarioNarrativeModel:
    subject = 'scenario narrative'
    lens = 'decision framing'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics) -> ScenarioNarrativeModelResult:
        return ScenarioNarrativeModelResult(
