...
"""Research signal for regulatory rent restrictions."""
...
class RentControlSignalObservation:
    signal_name: str
    raw_value: float
...
class RentControlSignal:
    name = 'regulatory rent restrictions'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> RentControlSignalObservation:
        ...
        return RentControlSignalObservation(
