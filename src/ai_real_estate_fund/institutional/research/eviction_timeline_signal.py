...
"""Research signal for remedy timeline."""
...
class EvictionTimelineSignalObservation:
    signal_name: str
    raw_value: float
...
class EvictionTimelineSignal:
    name = 'remedy timeline'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> EvictionTimelineSignalObservation:
        ...
        return EvictionTimelineSignalObservation(
