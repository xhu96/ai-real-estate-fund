...
"""Research signal for leasing absorption."""
...
class AbsorptionVelocitySignalObservation:
    signal_name: str
    raw_value: float
...
class AbsorptionVelocitySignal:
    name = 'leasing absorption'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> AbsorptionVelocitySignalObservation:
        ...
        return AbsorptionVelocitySignalObservation(
