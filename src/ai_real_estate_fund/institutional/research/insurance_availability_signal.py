...
"""Research signal for insurance market depth."""
...
class InsuranceAvailabilitySignalObservation:
    signal_name: str
    raw_value: float
...
class InsuranceAvailabilitySignal:
    name = 'insurance market depth'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> InsuranceAvailabilitySignalObservation:
        ...
        return InsuranceAvailabilitySignalObservation(
