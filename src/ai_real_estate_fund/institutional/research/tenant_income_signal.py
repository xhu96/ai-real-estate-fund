...
"""Research signal for tenant income support."""
...
class TenantIncomeSignalObservation:
    signal_name: str
    raw_value: float
...
class TenantIncomeSignal:
    name = 'tenant income support'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> TenantIncomeSignalObservation:
        ...
        return TenantIncomeSignalObservation(
