...
"""Research signal for physical climate exposure."""
...
class ClimateExposureSignalObservation:
    signal_name: str
    raw_value: float
...
class ClimateExposureSignal:
    name = 'physical climate exposure'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> ClimateExposureSignalObservation:
        ...
        return ClimateExposureSignalObservation(
