...
"""Research signal for safety trend."""
...
class CrimeTrendSignalObservation:
    signal_name: str
    raw_value: float
...
class CrimeTrendSignal:
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> CrimeTrendSignalObservation:
        ...
        return CrimeTrendSignalObservation(
