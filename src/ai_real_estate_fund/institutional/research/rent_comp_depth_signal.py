...
"""Research signal for rent-comp breadth."""
...
class RentCompDepthSignalObservation:
    signal_name: str
    raw_value: float
...
class RentCompDepthSignal:
    name = 'rent-comp breadth'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> RentCompDepthSignalObservation:
        ...
        return RentCompDepthSignalObservation(
