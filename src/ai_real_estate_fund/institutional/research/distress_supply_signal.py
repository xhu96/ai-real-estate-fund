...
"""Research signal for distressed-sale inventory."""
...
class DistressSupplySignalObservation:
    signal_name: str
    raw_value: float
...
class DistressSupplySignal:
    name = 'distressed-sale inventory'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> DistressSupplySignalObservation:
        ...
        return DistressSupplySignalObservation(
