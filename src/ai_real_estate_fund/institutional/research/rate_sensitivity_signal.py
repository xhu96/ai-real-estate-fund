...
"""Research signal for interest-rate sensitivity."""
...
class RateSensitivitySignalObservation:
    signal_name: str
    raw_value: float
...
class RateSensitivitySignal:
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> RateSensitivitySignalObservation:
        ...
        return RateSensitivitySignalObservation(
