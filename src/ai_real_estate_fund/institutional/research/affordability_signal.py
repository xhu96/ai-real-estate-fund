...
"""Research signal for rent-to-income affordability."""
...
class AffordabilitySignalObservation:
    signal_name: str
    raw_value: float
...
class AffordabilitySignal:
    name = 'rent-to-income affordability'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> AffordabilitySignalObservation:
        ...
        return AffordabilitySignalObservation(
