...
"""Research signal for tax reassessment pressure."""
...
class PropertyTaxSignalObservation:
    signal_name: str
    raw_value: float
...
class PropertyTaxSignal:
    name = 'tax reassessment pressure'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> PropertyTaxSignalObservation:
        ...
        return PropertyTaxSignalObservation(
