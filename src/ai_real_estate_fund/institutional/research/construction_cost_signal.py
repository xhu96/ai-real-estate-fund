...
"""Research signal for construction-cost pressure."""
...
class ConstructionCostSignalObservation:
    signal_name: str
    raw_value: float
...
class ConstructionCostSignal:
    name = 'construction-cost pressure'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> ConstructionCostSignalObservation:
        ...
        return ConstructionCostSignalObservation(
