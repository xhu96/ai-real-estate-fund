...
"""Research signal for commute accessibility."""
...
class TransitCommuteSignalObservation:
    signal_name: str
    raw_value: float
...
class TransitCommuteSignal:
    name = 'commute accessibility'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> TransitCommuteSignalObservation:
        ...
        return TransitCommuteSignalObservation(
