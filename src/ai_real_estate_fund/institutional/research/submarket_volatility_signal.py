...
"""Research signal for submarket volatility."""
...
class SubmarketVolatilitySignalObservation:
    signal_name: str
    raw_value: float
...
class SubmarketVolatilitySignal:
    name = 'submarket volatility'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> SubmarketVolatilitySignalObservation:
        ...
        return SubmarketVolatilitySignalObservation(
