...
"""Research signal for contractor availability."""
...
class LaborAvailabilitySignalObservation:
    signal_name: str
    raw_value: float
...
class LaborAvailabilitySignal:
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> LaborAvailabilitySignalObservation:
        ...
        return LaborAvailabilitySignalObservation(
