...
"""Research signal for neighborhood momentum."""
...
class NeighborhoodMomentumSignalObservation:
    signal_name: str
    raw_value: float
...
class NeighborhoodMomentumSignal:
    name = 'neighborhood momentum'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> NeighborhoodMomentumSignalObservation:
        ...
        return NeighborhoodMomentumSignalObservation(
