...
"""Research signal for new supply pipeline."""
...
class PermitSupplySignalObservation:
    signal_name: str
    raw_value: float
...
class PermitSupplySignal:
    name = 'new supply pipeline'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> PermitSupplySignalObservation:
        ...
        return PermitSupplySignalObservation(
