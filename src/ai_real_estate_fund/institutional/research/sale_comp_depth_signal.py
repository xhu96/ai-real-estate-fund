...
"""Research signal for sale-comp breadth."""
...
class SaleCompDepthSignalObservation:
    signal_name: str
    raw_value: float
...
class SaleCompDepthSignal:
    name = 'sale-comp breadth'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> SaleCompDepthSignalObservation:
        ...
        return SaleCompDepthSignalObservation(
