...
"""Research signal for inbound household migration."""
...
class MigrationSignalObservation:
    signal_name: str
    raw_value: float
...
class MigrationSignal:
    name = 'inbound household migration'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> MigrationSignalObservation:
        ...
        return MigrationSignalObservation(
