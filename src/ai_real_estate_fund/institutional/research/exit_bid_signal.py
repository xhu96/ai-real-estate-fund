...
"""Research signal for exit bid support."""
...
class ExitBidSignalObservation:
    signal_name: str
    raw_value: float
...
class ExitBidSignal:
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> ExitBidSignalObservation:
        ...
        return ExitBidSignalObservation(
