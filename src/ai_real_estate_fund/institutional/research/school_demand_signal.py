...
"""Research signal for school-driven demand."""
...
class SchoolDemandSignalObservation:
    signal_name: str
    raw_value: float
...
class SchoolDemandSignal:
    name = 'school-driven demand'
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> SchoolDemandSignalObservation:
        ...
        return SchoolDemandSignalObservation(
