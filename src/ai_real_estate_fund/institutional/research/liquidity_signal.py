...
"""Research signal for buyer depth."""
...
class LiquiditySignalObservation:
    signal_name: str
    raw_value: float
...
class LiquiditySignal:
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> LiquiditySignalObservation:
        ...
        return LiquiditySignalObservation(
