...
"""Research signal for employer concentration."""
...
class EmploymentDiversitySignalObservation:
    signal_name: str
    raw_value: float
...
class EmploymentDiversitySignal:
    ...
    def evaluate(self, prop: PropertyInput, metrics: UnderwritingMetrics, data: DiligenceDataBundle) -> EmploymentDiversitySignalObservation:
        ...
        return EmploymentDiversitySignalObservation(
